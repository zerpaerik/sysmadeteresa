		...
		<div class="box">
			<div class="box-header">
				<div class="box-name">
					...
					<span>Existencias/ Ingreso en Almacen Central</span>
					<a href="{{route('productos.in')}}" class="btn btn-primary">Agregar</a>
			...
			{!! Form::open(['method' => 'get', 'route' => ['reportentrada.index']]) !!}
			...
			<div class="row">
				@if($total)
				<strong>Cantidad</strong>:{{$total->total}}
				@endif
			</div>
