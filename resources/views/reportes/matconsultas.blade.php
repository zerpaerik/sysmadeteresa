		...
		<div class="box">
			<div class="box-header">
				<div class="box-name">
					...
					<span>Reportes/Materiales Usados Consulta</span>
			...
			{!! Form::open(['method' => 'get', 'route' => ['materialesconsultas.ver']]) !!}
					...
					<tbody>
                          @foreach($m as $atec)	
							 ...
							 <tr>
								<td>{{$atec->nombre}}</td>
								<td>{{$atec->total}}</td>
								<td><a target="_blank"  href="{{asset('matconsultas/ver')}}/{{$f1}}/{{$f2}}/{{$atec->id_producto}}" class="btn btn-xs btn-primary">Ver Detalle</a></td>
							</tr>
						@endforeach
					</tbody>
